...
public class TetriminosZ extends Tetriminos{
	...
	private Tetriminos bloc1 = new Tetriminos(Color.red, 50, 50, 200, 50);
	private Tetriminos bloc2 = new Tetriminos(Color.red, 50, 50, 150, 50);
	private Tetriminos bloc3 = new Tetriminos(Color.red, 50, 50, 150, 0);
	private Tetriminos bloc4 = new Tetriminos(Color.red, 50, 50, 100, 0);
	
	public TetriminosZ() {
		
	}
	
	public TetriminosZ(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
		bloc1 = new Tetriminos(Color.red, 50, 50, x1, y1);
		bloc2 = new Tetriminos(Color.red, 50, 50, x2, y2);
		bloc3 = new Tetriminos(Color.red, 50, 50, x3, y3);
		bloc4 = new Tetriminos(Color.red, 50, 50, x4, y4);
	}
	...
	// premet d'avoir l'index (la position) de la pièce
	public int getIndexRotate() {
		return indexRotate;
	}

	// permet de définir une nouvelle position (index)
	...
	public String toString() {
		return "TetriminosZ [color=" + color + ", bloc1=" + bloc1 + ", bloc2=" + bloc2 + ", bloc3=" + bloc3
				+ ", bloc4=" + bloc4 + "]";
	}
}
