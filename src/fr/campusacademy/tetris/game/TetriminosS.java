...
public class TetriminosS extends Tetriminos{
	...
	public TetriminosS(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
		bloc1 = new Tetriminos(Color.green, 50, 50, x1, y1);
		bloc2 = new Tetriminos(Color.green, 50, 50, x2, y2);
		bloc3 = new Tetriminos(Color.green, 50, 50, x3, y3);
	...
	public String toString() {
		return "TetriminosS [color=" + color + ", bloc1=" + bloc1 + ", bloc2=" + bloc2 + ", bloc3=" + bloc3
				+ ", bloc4=" + bloc4 + "]";
	}
}
