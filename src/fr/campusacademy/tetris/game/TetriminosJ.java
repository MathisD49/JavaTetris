...
public class TetriminosJ extends Tetriminos{
	...
	// on va instancier les blocs pour créer notre pièce
	...
	public TetriminosJ(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
		bloc1 = new Tetriminos(Color.orange, 50, 50, x1, y1);
		bloc2 = new Tetriminos(Color.orange, 50, 50, x2, y2);
		bloc3 = new Tetriminos(Color.orange, 50, 50, x3, y3);
		bloc4 = new Tetriminos(Color.orange, 50, 50, x4, y4);
	}
	...
	public String toString() {
		return "TetriminosJ [color=" + color + ", bloc1=" + bloc1 + ", bloc2=" + bloc2 + ", bloc3=" + bloc3
				+ ", bloc4=" + bloc4 + "]";
	}
}
